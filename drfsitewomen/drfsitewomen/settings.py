"""
Django settings for drfsitewomen project.
...
SECRET_KEY = 'django-insecure-ig(d9cn1^sjcl+5tjsua6w4+=r_&(xts0%+)is*0oh5a!q7mu)'
...
ROOT_URLCONF = 'drfsitewomen.urls'
...
WSGI_APPLICATION = 'drfsitewomen.wsgi.application'
...
TIME_ZONE = 'Europe/Moscow'  # смена часового пояса
...
REST_FRAMEWORK = {  # Управление глобальными настройками ДРФ(регулировка ДРФ)
    'DEFAULT_PAGINATION_CLASS': 'rest_framework.pagination.LimitOffsetPagination',  # класс пагинации по умолчанию
    'PAGE_SIZE': 2,  # кол-во записей на страницу (приоритет низкий)
...
SIMPLE_JWT = {  # настройки для simple jwt
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=5),  # жизнь accross-токена
    "REFRESH_TOKEN_LIFETIME": timedelta(days=1),  # жизнь refresh-токена
    "ROTATE_REFRESH_TOKENS": False,
    "BLACKLIST_AFTER_ROTATION": False,
    "UPDATE_LAST_LOGIN": False,

    "ALGORITHM": "HS256",  # метод шифрования
    "SIGNING_KEY": SECRET_KEY,  # секретный ключ Джанго
    "VERIFYING_KEY": "",
    "AUDIENCE": None,
    "ISSUER": None,
    "JSON_ENCODER": None,
    ...
    "AUTH_HEADER_TYPES": ("Bearer",),  # заголовок перед токеном в URL
    "AUTH_HEADER_NAME": "HTTP_AUTHORIZATION",
    "USER_ID_FIELD": "id",
    "USER_ID_CLAIM": "user_id",  # идентификатор с pk пользователя
    ...
    "SLIDING_TOKEN_REFRESH_EXP_CLAIM": "refresh_exp",  # жизнь "протухания" токенов в cookies
